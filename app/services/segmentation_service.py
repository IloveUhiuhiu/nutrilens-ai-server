...
from app.utils.image import decode_image_bytes, crop_image
from app.utils.segmentation import merge_masks_and_instances
...
class SegmentationService(ServiceBase):
    ...
    def segment_ingredients(
        ...
        self._log_info("enter segment_ingredients")
        """
        ...
        try:
            ...
            self._log_error("segmentation_service failed")
            raise
        finally:
            self._log_info("segmentation_service finished")
